...
LOGS = logging.getLogger("اعداد بيدو")
    ...
    try:
        if BOTLOG:
            Config.JMTHONLOGO = await sbb_b.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/a1f694950b0d722554bf1.jpg",
                caption="**تم تشغيل سورس بيدو بنجاح لعرض الاوامر ارسل .الاوامر**",
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "قروب بوت بيدو", sbb_b, Config.TG_BOT_USERNAME, descript, photobt
        )
