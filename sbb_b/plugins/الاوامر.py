...
async def hi(event):
    await edit_or_reply(
        event,
        "[ 𝖲𝗈𝖚rᴄ𝘦 𝘣id𝖚 ](t.me/biduso) اوامـر جلب الذاتية وامر الاضافة**:\n\n ⟸ `.ضيف`\n❖ اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ⟸`.جلب الصورة`  او  `.ذاتية`\n❖ بالرد على صورة او فيديو ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر لبيدو حصريا!",
    )
