...
@sbb_b.ar_cmd(pattern="صستيتنسيتسنشسيتنسشمسيس")
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس بيدو : 
        ...
        try:
            ch = await sbb_b(
                functions.channels.CreateChannelRequest(
                    title="bidu HUNTER - صيد بيدو",
                    about="This channel to hunt username by - @biduso ",
                )
            )
