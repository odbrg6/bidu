...
CATLOGO = "https://telegra.ph/file/a1f694950b0d722554bf1.jpg"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ𝘣id𝖚 ⵧⵧⵧⵧⵧ⍣**\n[ 𝘣id𝖚 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/biduso)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/biduso"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب بيدو **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/biduso"),
                Button.url(
                    "المطور",
                    "t.me/b_idu",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل بيدو من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝘣id𝖚 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/biduso)",
