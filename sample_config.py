...
class Config(object):
    ...
    # رابط الريبو
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com//odbrg6/bidu")
    # ملفات خارجيه اضافيه
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/odbrg6/TepPlugins"
    else:
        EXTERNAL_REPO = None
    # فارات الميوزك
    ...
    # فار قروبك الخاص هنا تخلي ايدي القروب عبر امر .الايدي
    ...
    # ايدي قروب لتخزين حتى يحفظ رسائل الخاص والمجمواعت الي تسويلك تاك
